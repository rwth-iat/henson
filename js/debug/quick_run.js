...
function quick_run_serverShutDown() {
  app.setVariable("/vendor/server_run", 0);
}

function quick_run_brad_test() {
  app.createObject("/acplt/malloc", "/acplt/ov/domain");
  var objpath = "/TechUnits/BRADTest";
  var factory = "/acplt/lbalanceTest/BRADTest";
  app.createObject("/acplt/lbalanceTest", "/acplt/ov/library");
  app.createObject(objpath, factory);
...
function quick_run_download_test() {
  app.createObject("/acplt/malloc", "/acplt/ov/domain");
  var objpath = "/TechUnits/downloadTest";
  var factory = "/acplt/CTreeTest/DownloadTest";
  app.createObject("/acplt/CTreeTest", "/acplt/ov/library");
  app.createObject(objpath, factory);
...
function quick_run2() {
  // creating
  var path = "/TechUnits/dummy";
  var factory = "/acplt/sync/dummy";
  ...
  // setting active to 3
  app.setVariable(path + ".actimode", 3);
...
function quick_run_dsyncTest() {
  ...
  // creating
  var objpath = "/TechUnits/dsyncTest";
  var factory = "/acplt/syncTest/dsyncTest";
  app.createObject(objpath, factory);
...
function quick_run_sscBufferTest() {
  //app.createObject("/acplt/malloc","/acplt/ov/domain");
  app.createObject("/acplt/TGraph", "/acplt/ov/library");
  app.createObject("/acplt/ovunity", "/acplt/ov/library");
  app.createObject("/acplt/gtpf", "/acplt/ov/library");
  app.createObject("/acplt/syncTest", "/acplt/ov/library");
  // creating
  var objpath = "/TechUnits/sscBufferTest";
  var factory = "/acplt/syncTest/sscBufferTest";
  app.createObject(objpath, factory);
...
function quick_run_msgCreatorTest() {
  //app.createObject("/acplt/malloc","/acplt/ov/domain");
  app.createObject("/acplt/TGraph", "/acplt/ov/library");
  app.createObject("/acplt/ovunity", "/acplt/ov/library");
  app.createObject("/acplt/gtpf", "/acplt/ov/library");
  app.createObject("/acplt/PostSysTest", "/acplt/ov/library");
  // creating
  var objpath = "/TechUnits/MsgDeliveryTest";
  var factory = "/acplt/PostSysTest/MsgDeliveryTest";
  app.createObject(objpath, factory);
...
function quick_run_gtpfTest() {
  ...
  // var factory = "/acplt/gtpfTest/assoziererTest";
  app.createObject(objpath, factory);
